-- 002_prestations_catalogue_pg.sql
-- PostgreSQL-compatible version of 002_prestations_catalogue.sql
...
DROP TABLE IF EXISTS prestations_catalogue CASCADE;

CREATE TABLE IF NOT EXISTS prestations_catalogue (
    id TEXT PRIMARY KEY,
    categorie TEXT NOT NULL,
    libelle TEXT NOT NULL,
    prix_main_oeuvre_ht NUMERIC NOT NULL,
    tva_pct NUMERIC DEFAULT 20.0,
